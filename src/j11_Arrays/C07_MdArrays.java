 ...
 *  en distaki array haric, elemana kadar ic ice olan tum arraylerin indexlerini yazmak gerekir
        ...
        int [][]arr1 = new int[3][5];//3 katlı her katta 5 daire olan boş bir multidimensional array tanımlandı->default 0 atandı
        // bir okul için 7 sınıflı ve 24 öğrencili bir array oluşturalım.
        int [][]okul = new int[7][24];

        //Md arraya eleman atama
        arr1[1][3]=21;
        arr1[2][4]=42;
        //arr1[3][7]=55;//RTE hatası verir.out of bound
        System.out.println("arr1[1][3] = " + arr1[1][3]);
        System.out.println("arr1[2][4] = " + arr1[2][4]);
        System.out.println("arr1[0][2] = " + arr1[0][2]); //->atama yapılmayan eleman default olarak hangi tip ise ona göre bir değer atanır.
       // System.out.println("arr1[3][7] = " + arr1[3][7]);
