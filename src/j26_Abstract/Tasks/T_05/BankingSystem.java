...
public class BankingSystem {
    public static void main(String[] args) {
        ...
        j26_Abstract.abstract06.Bank hesabinBankasi = null;
        switch (bankaSecim) {
            case 1:
                // Bank hesabinBankasi = new BOA(ad,telNo, adres, employeeNo);
                hesabinBankasi = new j26_Abstract.abstract06.BOA(ad, telNo, adres, employeeNo);
                hesabinBankasi.openAccount();
                break;

            case 2:
                hesabinBankasi = new j26_Abstract.abstract06.WellsFargo(ad, telNo, adres, employeeNo);
                hesabinBankasi.openAccount();
                break;

            case 3:
                hesabinBankasi = new j26_Abstract.abstract06.ChaseBank(ad, telNo, adres, employeeNo);
                hesabinBankasi.openAccount();
                break;
        }
