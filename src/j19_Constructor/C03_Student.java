 ...
 */
        ...
        C03_Student s1 = new C03_Student();//p siz const ile s1 objesi create edildi.
        s1.ad="Bahtiyar".toUpperCase();
        s1.soyad="Aydın".toUpperCase();
        s1.okulNo=1453;
        s1.sınıf=12;
        s1.ortalama=85.0;
    ...
    private void sosyalFaaliyet() {
        System.out.println("Sen evde oturmayı faaliyet mi sandın");
    }

    public String mezuniyet(double ort){
        return  ort>50?"Mezun oldunuz":"Tuh sana buda gol değil";
