...
*/
        C02_Encapsulation obj1 = new C02_Encapsulation();//p siz const call edilerek obj create edildi.
        obj1.ad="Halit Bey";
        obj1.soyad="Guzel";
        //System.out.println("obj1.idVer() = " + obj1.idVer());
        obj1.ad="Safvet Bey";//encapsule edilmeyen variable obj ile call edilip update edilebilir
