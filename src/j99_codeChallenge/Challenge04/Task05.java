...
public class Task05 {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("4 kelime giriniz ");
        String kelime1 = input.next();
        String kelime2 = input.next();
        String kelime3 = input.next();
        String kelime4 = input.next();
        System.out.println("kelime1.toUpperCase().charAt(0)+kelime1.substring(1)+\" \"+kelime2+\" \"+kelime3+\" \"+kelime4+\" \" = " + kelime1.toUpperCase().charAt(0) + kelime1.substring(1) + " " + kelime2 + " " + kelime3 + " " + kelime4 + " ");
