...
public class MusteriEkle {
    MusteriEkle() {
        ...
        while (true) {
            j25_Exceptions.Tasks.Task07._02.Account account = new j25_Exceptions.Tasks.Task07._02.Account();
            ...
            j25_Exceptions.Tasks.Task07._02.Account yeniAccount = new j25_Exceptions.Tasks.Task07._02.Account(account.getAccountNumber(), account.getAdSoyad(), account.getBakiye(), account.getGunlukLimit());
