...
*/
        List<String>l1=new ArrayList<String>(Arrays.asList("Sema","Semra","Dogukan","Ahmet","Halit","Tuba","Seher"));
 ...
 */
        ...
        ListIterator<String>lit1=l2.listIterator();
        while (lit1.hasNext()){
            lit1.set(lit1.next()+":-)");
        }
        System.out.println("l2 = " + l2);
        ...
        ListIterator<String>lit2=l3.listIterator();
        while (lit2.hasNext()){
